...
const r22 = calcularFizzBuzzRefactor(351); // fizz
const r33 = calcularFizzBuzzRefactor(75); // fuzzbuzz
const r44 = calcularFizzBuzzRefactor(true);
...
/**
 * Esta función sirve para identificar las moenas
 * @param {string} moneda 
 * @returns {string}
 */
